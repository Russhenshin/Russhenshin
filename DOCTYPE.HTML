...
<script src="./assets/c312f280/jssearch.js"></script>    <title>Yii Framework 2.0 API Documentation</title>
</head>
<body>

<div class="wrap">
    <nav id="w20234" class="navbar-inverse navbar-fixed-top navbar"><div class="navbar-header"><button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#w20234-collapse"><span class="sr-only">Toggle navigation</span>
<span class="icon-bar"></span>
<span class="icon-bar"></span>
<span class="icon-bar"></span></button><a class="navbar-brand" href="./index.html">Yii Framework 2.0 API Documentation</a></div><div id="w20234-collapse" class="collapse navbar-collapse"><ul id="w20235" class="navbar-nav nav"><li><a href="./index.html">Class reference</a></li>
<li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Extensions <span class="caret"></span></a><ul id="w20236" class="dropdown-menu"><li><a href="./ext-apidoc-index.html" tabindex="-1">apidoc</a></li>
...
<div class="row">
    <div class="col-md-3">
                <div id="navigation" class="list-group"><a class="list-group-item" href="#navigation-20223" data-toggle="collapse" data-parent="#navigation">yii\apidoc\commands <b class="caret"></b></a><div id="navigation-20223" class="submenu panel-collapse collapse"><a class="list-group-item" href="./yii-apidoc-commands-apicontroller.html">ApiController</a>
<a class="list-group-item" href="./yii-apidoc-commands-guidecontroller.html">GuideController</a></div>
<a class="list-group-item" href="#navigation-20224" data-toggle="collapse" data-parent="#navigation">yii\apidoc\components <b class="caret"></b></a><div id="navigation-20224" class="submenu panel-collapse collapse"><a class="list-group-item" href="./yii-apidoc-components-basecontroller.html">BaseController</a></div>
<a class="list-group-item" href="#navigation-20225" data-toggle="collapse" data-parent="#navigation">yii\apidoc\helpers <b class="caret"></b></a><div id="navigation-20225" class="submenu panel-collapse collapse"><a class="list-group-item" href="./yii-apidoc-helpers-apiindexer.html">ApiIndexer</a>
...
<a class="list-group-item" href="./yii-apidoc-helpers-brokenlinkexception.html">BrokenLinkException</a>
<a class="list-group-item" href="./yii-apidoc-helpers-indexfileanalyzer.html">IndexFileAnalyzer</a>
<a class="list-group-item" href="./yii-apidoc-helpers-markdownhighlighttrait.html">MarkdownHighlightTrait</a>
<a class="list-group-item" href="./yii-apidoc-helpers-prettyprinter.html">PrettyPrinter</a></div>
<a class="list-group-item" href="#navigation-20226" data-toggle="collapse" data-parent="#navigation">yii\apidoc\models <b class="caret"></b></a><div id="navigation-20226" class="submenu panel-collapse collapse"><a class="list-group-item" href="./yii-apidoc-models-basedoc.html">BaseDoc</a>
...
<a class="list-group-item" href="#navigation-20227" data-toggle="collapse" data-parent="#navigation">yii\apidoc\renderers <b class="caret"></b></a><div id="navigation-20227" class="submenu panel-collapse collapse"><a class="list-group-item" href="./yii-apidoc-renderers-apirenderer.html">ApiRenderer</a>
...
<a class="list-group-item" href="#navigation-20228" data-toggle="collapse" data-parent="#navigation">yii\apidoc\templates\bootstrap <b class="caret"></b></a><div id="navigation-20228" class="submenu panel-collapse collapse"><a class="list-group-item" href="./yii-apidoc-templates-bootstrap-apirenderer.html">ApiRenderer</a>
...
<a class="list-group-item" href="#navigation-20229" data-toggle="collapse" data-parent="#navigation">yii\apidoc\templates\bootstrap\assets <b class="caret"></b></a><div id="navigation-20229" class="submenu panel-collapse collapse"><a class="list-group-item" href="./yii-apidoc-templates-bootstrap-assets-assetbundle.html">AssetBundle</a>
...
<a class="list-group-item" href="#navigation-20230" data-toggle="collapse" data-parent="#navigation">yii\apidoc\templates\html <b class="caret"></b></a><div id="navigation-20230" class="submenu panel-collapse collapse"><a class="list-group-item" href="./yii-apidoc-templates-html-apirenderer.html">ApiRenderer</a>
<a class="list-group-item" href="./yii-apidoc-templates-html-guiderenderer.html">GuideRenderer</a></div>
<a class="list-group-item" href="#navigation-20231" data-toggle="collapse" data-parent="#navigation">yii\apidoc\templates\json <b class="caret"></b></a><div id="navigation-20231" class="submenu panel-collapse collapse"><a class="list-group-item" href="./yii-apidoc-templates-json-apirenderer.html">ApiRenderer</a></div>
<a class="list-group-item" href="#navigation-20232" data-toggle="collapse" data-parent="#navigation">yii\apidoc\templates\online <b class="caret"></b></a><div id="navigation-20232" class="submenu panel-collapse collapse"><a class="list-group-item" href="./yii-apidoc-templates-online-apirenderer.html">ApiRenderer</a></div>
<a class="list-group-item" href="#navigation-20233" data-toggle="collapse" data-parent="#navigation">yii\apidoc\templates\pdf <b class="caret"></b></a><div id="navigation-20233" class="submenu panel-collapse collapse"><a class="list-group-item" href="./yii-apidoc-templates-pdf-guiderenderer.html">GuideRenderer</a></div></div>    </div>
    <div class="col-md-9 api-content" role="main"><p align="center">
...
<p>This extension provides an API documentation generator for the <a href="https://www.yiiframework.com">Yii framework 2.0</a>.</p>
...
<a href="https://packagist.org/packages/yiisoft/yii2-apidoc"><img src="https://poser.pugx.org/yiisoft/yii2-apidoc/downloads.png" alt="Total Downloads" /></a>
<a href="https://github.com/yiisoft/yii2-apidoc/actions"><img src="https://github.com/yiisoft/yii2-apidoc/workflows/build/badge.svg" alt="Build Status" /></a></p>
<h2>Installation <span id="installation"></span><a href="#installation" class="hashlink">&para;</a></h2><p>The preferred way to install this extension is through <a href="https://getcomposer.org/download/">composer</a>.</p>
<p>Either run</p>
<pre><code class="hljs nginx"><span class="hljs-attribute">composer</span> require --prefer-dist yiisoft/yii2-apidoc:<span class="hljs-string">"~3.0.6"</span>
</code></pre>
<p>The above command may not work on an existing project due to version conflicts that need to be resolved, so it
is preferred to add the package manually to the <code>require</code> section of your composer.json:</p>
<pre><code class="hljs json language-json"><span class="hljs-string">"yiisoft/yii2-apidoc"</span>: <span class="hljs-string">"~3.0.6"</span>
</code></pre>
<p>afterwards run <code>composer update</code>. You may also run <code>composer update yiisoft/yii2-apidoc cebe/markdown</code> if you
want to avoid updating unrelated packages.</p>
<h2>Usage <span id="usage"></span><a href="#usage" class="hashlink">&para;</a></h2><p>This extension creates executable at <code>/vendor/bin</code>. Please do change directory to that directory if you  do not want to use full path i.e <code>/vendor/bin/apidoc</code> and use just the executable name as with below examples.</p>
<p>This extension offers two commands:</p>
<p>1)<code>api</code> to generate class API documentation. <a href="https://www.phpdoc.org/">phpDocumentor</a> is used as a base framework
  so refer to its guide for the syntax.</p>
<p>The output of <code>help api</code> command (i.e <code>apidoc help api</code>):</p>
<pre><code class="hljs markdown">DESCRIPTION
...
apidoc api <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">sourceDirs</span>&gt;</span></span> <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">targetDir</span>&gt;</span></span> [...options...]
<span class="hljs-bullet">
- </span>sourceDirs (required): array
<span class="hljs-bullet">
- </span>targetDir (required): string
...
--repo-url: string
  ...
  within a repository (e.g. "[<span class="hljs-string">docs/guide/README.md</span>](<span class="hljs-link">docs/guide/README.md</span>)"). If you don't have such links you can
...
--silent-exit-on-exception: boolean, 0 or 1
  if true - script finish with <span class="hljs-code">`ExitCode::OK`</span> in case of exception.
  false - <span class="hljs-code">`ExitCode::UNSPECIFIED_ERROR`</span>.
  Default: <span class="hljs-code">`YII_ENV_TEST`</span>

--template: string (defaults to 'bootstrap')
  template to use for rendering
</code></pre>
<p>2)<code>guide</code> to render nice HTML pages from markdown files such as the yii guide.</p>
<p>The output of <code>help guide</code> command (i.e <code>apidoc help guide</code>):</p>
<pre><code class="hljs php">DESCRIPTION
...
- sourceDirs (required): <span class="hljs-keyword">array</span>
...
--api-docs: string
  path <span class="hljs-keyword">or</span> URL to the api docs to allow links to classes <span class="hljs-keyword">and</span> properties/methods.

--appconfig: string
  custom application configuration file path.
  <span class="hljs-keyword">If</span> not set, <span class="hljs-keyword">default</span> application configuration is used.

--color: boolean, <span class="hljs-number">0</span> <span class="hljs-keyword">or</span> <span class="hljs-number">1</span>
  whether to enable ANSI color in the output.
  <span class="hljs-keyword">If</span> not set, ANSI color will only be enabled <span class="hljs-keyword">for</span> terminals that support it.

--exclude: string|<span class="hljs-keyword">array</span>
  files to exclude.

--guide-prefix: string (defaults to <span class="hljs-string">'guide-'</span>)
  prefix to prepend to all output file names generated <span class="hljs-keyword">for</span> the guide.

--help, -h: boolean, <span class="hljs-number">0</span> <span class="hljs-keyword">or</span> <span class="hljs-number">1</span> (defaults to <span class="hljs-number">0</span>)
  whether to display help information about current command.

--interactive: boolean, <span class="hljs-number">0</span> <span class="hljs-keyword">or</span> <span class="hljs-number">1</span> (defaults to <span class="hljs-number">1</span>)
  whether to run the command interactively.

--page-title: string

--silent-<span class="hljs-keyword">exit</span>-on-<span class="hljs-keyword">exception</span>: boolean, <span class="hljs-number">0</span> <span class="hljs-keyword">or</span> <span class="hljs-number">1</span>
  <span class="hljs-keyword">if</span> <span class="hljs-keyword">true</span> - script finish with `ExitCode::OK` in <span class="hljs-keyword">case</span> of <span class="hljs-keyword">exception</span>.
  <span class="hljs-keyword">false</span> - `ExitCode::UNSPECIFIED_ERROR`.
  <span class="hljs-keyword">Default</span>: `YII_ENV_TEST`

--template: string (defaults to <span class="hljs-string">'bootstrap'</span>)
  template to <span class="hljs-keyword">use</span> <span class="hljs-title">for</span> <span class="hljs-title">rendering</span>
</code></pre>
...
<p>Note that in order to generate a proper index file, the <code>README.md</code> file containing links to guide sections must be 
present. An example of such file can be found 
in the <a href="https://raw.githubusercontent.com/yiisoft/yii2/master/docs/guide/README.md">yii2 repository</a>.</p>
...
and run them inside your application's console app.</p>
<h3>Generating docs from multiple sources <span id="generating-docs-from-multiple-sources"></span><a href="#generating-docs-from-multiple-sources" class="hashlink">&para;</a></h3><p>The apidoc generator can use multiple directories, so you can generate docs for your application and include the yii framework
docs to enable links between your classes and framework classes. This also allows <code>@inheritdoc</code> to work
for your classes that extend from the framework.
Use the following command to generate combined api docs:</p>
<pre><code class="hljs bash">./vendor/bin/apidoc api ./vendor/yiisoft/yii2,. docs/json --exclude=<span class="hljs-string">"docs,vendor"</span>

</code></pre>
<p>This will read the source files from <code>./vendor/yiisoft/yii2</code> directory and <code>.</code> which is the current directory (you may replace this with the location of your code if it is not in the current working directory).</p>
...
<pre><code class="hljs bash language-sh"><span class="hljs-meta">#!/bin/sh
</span>
...
./apidoc api <span class="hljs-variable">$YII_PATH</span>/framework/,<span class="hljs-variable">$YII_PATH</span>/extensions <span class="hljs-variable">$OUTPUT</span>/api --guide=../guide-en --guidePrefix= --interactive=0
./apidoc guide <span class="hljs-variable">$YII_PATH</span>/docs/guide    <span class="hljs-variable">$OUTPUT</span>/guide-en --apiDocs=../api --guidePrefix= --interactive=0
./apidoc guide <span class="hljs-variable">$YII_PATH</span>/docs/guide-ru <span class="hljs-variable">$OUTPUT</span>/guide-ru --apiDocs=../api --guidePrefix= --interactive=0
<span class="hljs-comment"># repeat the last line for more languages</span>
</code></pre>
<h3>Creating a PDF of the guide <span id="creating-a-pdf-of-the-guide"></span><a href="#creating-a-pdf-of-the-guide" class="hashlink">&para;</a></h3><p>Prerequisites:</p>
<ul>
...
<h2>Special Markdown Syntax <span id="special-markdown-syntax"></span><a href="#special-markdown-syntax" class="hashlink">&para;</a></h2><p>We have a special Syntax for linking to a class in the API documentation.
...
<h2>Creating your own templates <span id="creating-your-own-templates"></span><a href="#creating-your-own-templates" class="hashlink">&para;</a></h2><p>TBD</p>
<h2>Using the model layer <span id="using-the-model-layer"></span><a href="#using-the-model-layer" class="hashlink">&para;</a></h2><p>TBD</p>
...
or your own applications documentation setup.</td>
    ...
    <tr>
        <td><a href="yii-apidoc-helpers-brokenlinkexception.html">yii\apidoc\helpers\BrokenLinkException</a></td>
        <td>BrokenLinkException represents a broken API link.</td>
    </tr>
    <tr>
    ...
    <tr>
        <td><a href="yii-apidoc-helpers-markdownhighlighttrait.html">yii\apidoc\helpers\MarkdownHighlightTrait</a></td>
        <td>MarkdownHighlightTrait provides code highlighting functionality for Markdown Parsers.</td>
    </tr>
    <tr>
        <td><a href="yii-apidoc-helpers-prettyprinter.html">yii\apidoc\helpers\PrettyPrinter</a></td>
        <td>Enhances the phpDocumentor PrettyPrinter:</td>
    </tr>
    <tr>
...
<footer class="footer">
        <p class="pull-right"><small>Page generated on Mon, 25 Mar 2024 03:59:14 +0000</small></p>
